/*
  ...
  - The values [UNAVALIABLE] on the enum `State` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "State_new" AS ENUM ('AVAILABLE', 'UNAVAILABLE', 'RESERVED');
